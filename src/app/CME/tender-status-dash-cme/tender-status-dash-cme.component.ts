...
exportToPDFHODDetails() {
  ...
  const columns = [
    ...
    { header: 'Start Date', dataKey: 'startdt' },
    { header: 'Actual Closing Date', dataKey: 'actclosingdt' },
    { header: 'No of Items', dataKey: 'noofitems' },
    { header: 'Item AEDL', dataKey: 'itemaedl' },
    { header: 'Price Bid Date', dataKey: 'pricebiddate' },
    { header: 'No. of Bids', dataKey: 'nooF_BID_A' },
    { header: 'Remarks', dataKey: 'remarksdata' },
    { header: 'Status', dataKey: 'status' },
    { header: 'Tender Value', dataKey: 'tenderValue' },
    { header: 'Tender Remark', dataKey: 'tenderremark' }, // Hindi content here
    { header: 'Remark Entry Date', dataKey: 'remarkEntryDate' }
  ];
