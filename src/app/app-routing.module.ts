...
const routes: Routes = [
  ...
  { path: 'executivesupplychain-insights', component: ExecutiveSupplyChain, canActivate: [RouteGuardService], data: { allowedRoles: ['SSO', 'DHS', 'DHS STORE', 'SEC1', 'CME', 'DME1', 'Warehouse', 'DM PO', 'QC', 'QC2', 'Tenders', 'Division'] } },
