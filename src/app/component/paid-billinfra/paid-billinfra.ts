...
displayedColumns1: string[] = ['sno', 'division', 'head', 'noofWorks', 'grosspaid','netAmtLacs'];
  PaidDetails: any[] = [];
...
FundWisepdf() {
  ...
  autoTable(doc, {
    ...
    columnStyles: {
      ...
      3: { cellWidth: 35, halign: 'right' },   // Gross Paid
      4: { cellWidth: 35, halign: 'right' }    // Net Amount
    },
