...
import { TenderStatusDashboardComponent } from "../tender-status-dashboard/tender-status-dashboard.component";
import { RcStatusDashboardComponent } from "../rc-status-dashboard/rc-status-dashboard.component";


@Component({
  selector: 'app-tender-dashboard',
  standalone: true,
  imports: [CommonModule, MatTabsModule, TenderStatusOracleComponent, ItemTypeWiseTenderStatusComponent, DrugTenderStatusComponent, ItemWiseTenderStatusComponent, TenderDashboardComponent, TenderStatusDashboardComponent, RcStatusDashboardComponent],
  templateUrl: './tender-dashboard.component.html',
  styleUrl: './tender-dashboard.component.css'
})
