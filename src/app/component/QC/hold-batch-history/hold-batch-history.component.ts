...
startDateValidator(control: AbstractControl) {
  ...
  exportToPDF() {
    ...
    const columns = [
      ...
      { header: 'PODATE', dataKey: 'podate' },
      { header: 'SUPPLIERNAME', dataKey: 'suppliername' },
      { header: 'BATCH NO', dataKey: 'batchno' },
      { header: 'MFG DATE', dataKey: 'mfgdate' },
      { header: 'EXP DATE', dataKey: 'expdate' },
      { header: 'HOLD STOCK', dataKey: 'holdStock' },
      { header: 'HOLD DATE', dataKey: 'holddate' },
      { header: 'HOLDREASON', dataKey: 'holdreason' },
      { header: 'RECEIPT FROM SUPPLIER', dataKey: 'supplierReceipt' },
      { header: 'RECEIPT FROM INTER WAREHOUSE TRANSFER', dataKey: 'iwhReceiptQTy' },
      { header: 'FACILITY ISSUE', dataKey: 'fac_iss_qty' },
      { header: 'RETURN FROM FACILITY', dataKey: 'rF_Qty' },
      { header: 'RETURN TO SUPPLIER', dataKey: 'rsqty' },
      { header: 'REPLACED QTY BY SUPPLIER', dataKey: 'rpqty' },
    ];
