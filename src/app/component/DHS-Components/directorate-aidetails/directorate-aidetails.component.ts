...
console.log('groupidMap:', this.groupidMap); 
  ...
  exportToPDF() {
    ...
    const columns = [
      ...
      { header: "AI", dataKey: "dhsai" },
      { header: "PO QTY", dataKey: "poqty" },
      { header: "Rec QTY", dataKey: "rqty" },
      { header: "PO Value(in Cr)", dataKey: "povalue" },
      { header: "Rec Value(in Cr)", dataKey: "rvalue" },
      { header: "Rec %", dataKey: "rPercentage" },
