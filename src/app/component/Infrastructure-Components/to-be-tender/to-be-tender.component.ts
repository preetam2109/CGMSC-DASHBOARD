...
export class ToBeTenderComponent {
  ...
  CANexportToPDF34() {
    ...
    const columns = [
      ...
      { header: 'Proposed Letter No', dataKey: 'letterno' },
      { header: 'Health Center', dataKey: 'detailS_ENG' },
      { header: 'Work', dataKey: 'workname' },
      { header: 'AS Amount(In Lacs)', dataKey: 'valueWorks' },
      { header: 'AS DT', dataKey: 'asDate' },
      { header: 'Proposed Letter No', dataKey: 'woCancelProposalLetterNo' },
      { header: 'Proposed DT', dataKey: 'pDate' },
  ...
  CANexportToPDF() {
    ...
    const columns = [
      ...
      { header: 'AS DT', dataKey: 'asDate' },
      { header: 'Proposed Letter No', dataKey: 'woCancelProposalLetterNo' },
      { header: 'Cancelled LetterNo_HO', dataKey: 'wocancelletterno' },
      { header: 'Cancelled DT', dataKey: 'pDate' },
      { header: 'Work ID', dataKey: 'work_id' },
    ];
  ...
  exportToPDF() {
    ...
    const columns = [
      ...
      { header: 'AS Amount (In Lacs)', dataKey: 'valueWorks' },
      { header: 'AS DT', dataKey: 'asDate' },
      //  { header: 'parentprogress', dataKey: 'parentprogress' },
      //  { header: 'dashName', dataKey: 'dashName' },
  ...
  SexportToPDF() {
    ...
    const columns = [
      ...
      { header: 'Work ID', dataKey: 'work_id' },
      { header: 'Work Name', dataKey: 'workname' },
      { header: 'DetailS', dataKey: 'detailS_ENG' },
      { header: 'Value Works', dataKey: 'valueWorks' },
      { header: 'AS Date', dataKey: 'asDate' },
      { header: 'Parent Progress', dataKey: 'parentprogress' },
      { header: 'Dash Name', dataKey: 'dashName' },
      { header: 'Group Name', dataKey: 'groupName' },
      { header: 'P Date', dataKey: 'pDate' },
      { header: 'RejReason', dataKey: 'rejReason' },
      { header: 'RejectedDT', dataKey: 'rejectedDT' },
      { header: 'LastNIT', dataKey: 'lastNIT' },
      { header: 'Ppid', dataKey: 'ppid' },
      { header: 'Last Eprocno', dataKey: 'lastEprocno' },
    ];
  ...
  ZexportToPDF() {
    ...
    const columns = [
      ...
      { header: 'Division', dataKey: 'division' },
      { header: 'District', dataKey: 'district' },
      { header: 'Block Name', dataKey: 'block_Name_En' },
      { header: 'Work ID', dataKey: 'work_id' },
      { header: 'Work Name', dataKey: 'workname' },
      { header: 'DetailS', dataKey: 'detailS_ENG' },
      ...
      { header: 'Nit No', dataKey: 'nitNo' },
      { header: 'Ppid', dataKey: 'ppid' },
      { header: 'Tender ID', dataKey: 'tenderID' },
      { header: 'Apild', dataKey: 'apild' },
    ];
