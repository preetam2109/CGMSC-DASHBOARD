...
export class SchemeWiseDetailsComponent {
  ...
  exportToPDFTW() {
    ...
    const columns = [
      ...
      { header: 'Total paid(In Lacs)', dataKey: 'totalpaid' },
      { header: 'Total unpaid(In Lacs)', dataKey: 'totalunpaid' },
      { header: 'Work Order DT', dataKey: 'workOrderDT' },
      { header: 'Time Allowed', dataKey: 'timeAllowed' },
      { header: 'Due DT Time PerAdded', dataKey: 'dueDTTimePerAdded' },
      { header: 'Work Order RefNo', dataKey: 'agreementRefNo' },
      { header: 'Contractor ID/Class', dataKey: 'cid' },
  ...
  expor_PDFLand_isu() {
    ...
    const columns = [
      ...
      { header: 'Work', dataKey: 'work' },
      { header: 'AS Date', dataKey: 'aadt' },
      { header: 'AS Amount (Lacs)', dataKey: 'asAmt' },
      { header: 'TS Date', dataKey: 'tsDate' },
      { header: 'TS Amount (Lacs)', dataKey: 'tsamt' },
      { header: 'Tender Type', dataKey: 'tType' },
      { header: 'NIT Reference', dataKey: 'tenderReference' },
      { header: 'NIT/Sanction DT', dataKey: 'dateOfIssueNIT' },
      { header: 'Acceptance Letter RefNo', dataKey: 'acceptanceLetterRefNo' },
      ...
      { header: 'Rate%', dataKey: 'sanctionRate' },
      { header: 'Sanction', dataKey: 'sanctionDetail' },
      { header: 'Contract Amount (Lacs)', dataKey: 'totalAmountOfContract' },
      { header: 'Total Paid (Lacs)', dataKey: 'totalpaid' },
      { header: 'Total Unpaid (Lacs)', dataKey: 'totalunpaid' },
      { header: 'Work Order DT', dataKey: 'wrokOrderDT' }, // (Consider renaming in data)
      { header: 'Time Allowed', dataKey: 'timeAllowed' },
      { header: 'Due DT Time PerAdded', dataKey: 'dueDTTimePerAdded' },
      { header: 'Work Order RefNo', dataKey: 'agreementRefNo' },
  ...
  UNexportToPDF() {
    ...
    const columns = [
      ...
      { header: 'Wrok Order DT', dataKey: 'wrokOrderDT' },
      { header: 'Bill No.', dataKey: 'billno' },
      { header: 'Bill Type', dataKey: 'agrbillstatus' },
      { header: 'Contract Value (In lacs)', dataKey: 'totalamountofcontract' },
      { header: 'Gross Amount Due(In lacs)', dataKey: 'grossAmtNew' },
      { header: 'Total Paid Till(In lacs)', dataKey: 'totalpaidtillinlac' },
      // { header: 'ChequeDT', dataKey: 'chequeDT' },
  ...
  exportToPDFPaid() {
    ...
    const columns = [
      ...
      { header: 'Contract Value (In lacs)', dataKey: 'totalamountofcontract' },
      { header: 'Gross Paid Value (In lacs)', dataKey: 'grosspaid' },
      { header: 'Total Paid Till(In lacs)', dataKey: 'totalpaidtillinlac' },
      { header: 'Cheque DT.', dataKey: 'chequeDT' },
      { header: 'Measurement DT', dataKey: 'mesurementDT' },
      { header: 'WorK ID', dataKey: 'worK_ID' },
    ];
  ...
  exportToPDFTE() {
    ...
    const columns = [
      ...
      { header: 'NO of Calls', dataKey: 'noofcalls' },
      { header: 'NIT NO', dataKey: 'tenderno' },
      { header: 'Cover A Opened DT', dataKey: 'tOpnedDT' },
      { header: 'Cover B Opened DT', dataKey: 'topnedbdt' },
      { header: 'Days Since Cov A/B Opned', dataKey: 'daysSinceOpen' },
      { header: 'e-Procno', dataKey: 'eprocno' },
    ];
